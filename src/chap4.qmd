...
<iframe
  src="../slides/3.1.active_learning/"
  style="width:45%; height:225px;"
></iframe>
<iframe
  src="../slides/3.2.metric_elicitation/"
  style="width:45%; height:225px;"
></iframe>
[Fullscreen - AL](../slides/3.1.active_learning/){.btn .btn-outline-primary .btn role="button"}
[Fullscreen - ME](../slides/3.2.metric_elicitation/){.btn .btn-outline-primary .btn role="button"}
